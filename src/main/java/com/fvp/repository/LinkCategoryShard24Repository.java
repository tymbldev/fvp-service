...
public interface LinkCategoryShard24Repository extends
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      nativeQuery = true)
  Optional<LinkCategoryShard24> findRandomRecentLinkByCategory(
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      "ORDER BY RAND() LIMIT 1",
      nativeQuery = true)
  Optional<LinkCategoryShard24> findRandomLinkByCategory(
      @Param("tenantId") Integer tenantId,
      @Param("category") String category
  );

  @Query(value =
      "SELECT COUNT(lc.id) AS count FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id "
          +
          "WHERE lc.tenant_id = :tenantId AND lc.category = :category " +
          "AND l.thumb_path_processed = 1",
      nativeQuery = true)
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      "AND l.thumb_path_processed = 1",
      nativeQuery = true)
  List<LinkCategoryShard24> findByTenantIdAndLinkId(
      @Param("tenantId") Integer tenantId,
      @Param("linkId") Integer linkId
  );

  @Query(value = "SELECT DISTINCT lc.category FROM link_category_shard_24 lc " +
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      "AND l.thumb_path_processed = 1",
      nativeQuery = true)
  List<LinkCategoryShard24> findByTenantIdAndCategory(
      @Param("tenantId") Integer tenantId,
      @Param("category") String category
  );
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      nativeQuery = true)
  List<LinkCategoryShard24> findByTenantIdAndCategoryOrderByRandomOrder(
      @Param("tenantId") Integer tenantId,
      @Param("category") String category
  );
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      nativeQuery = true)
  List<LinkCategoryShard24> findByCategoryWithFiltersPageable(
      @Param("tenantId") Integer tenantId,
      @Param("category") String category,
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      "ORDER BY lc.random_order LIMIT :limit OFFSET :offset",
      nativeQuery = true)
  List<LinkCategoryShard24> findByCategoryWithFiltersExcludingLinkPageable(
      @Param("tenantId") Integer tenantId,
      @Param("category") String category,
      @Param("minDuration") Integer minDuration,
      @Param("maxDuration") Integer maxDuration,
  ...
  @Query(value = "SELECT lc.* FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id " +
      ...
      "ORDER BY RAND()",
      nativeQuery = true)
  List<LinkCategoryShard24> findRandomLinksByCategoryNames(
      @Param("tenantId") Integer tenantId,
      @Param("categoryNames") List<String> categoryNames
  );

  @Query(value =
      "SELECT lc.category, COUNT(lc.id) as count FROM link_category_shard_24 lc JOIN link l ON lc.link_id = l.id "
          +
