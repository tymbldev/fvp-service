...
public interface LinkCategoryShard16Repository extends
  ...
  @Override
  default Optional<LinkCategoryShard16> findRandomRecentLinkByCategory(
      Integer tenantId,
      String category,
      Long recentDays
  ) {
      ...
      return queryBuilder.findRandomRecentLinkByCategory(
          LinkCategoryShard16.class, tenantId, category, recentDays
      );
  }

  @Override
  default Optional<LinkCategoryShard16> findRandomLinkByCategory(
      Integer tenantId,
      String category
  ) {
      // Get the query builder from Spring context
      ...
      return queryBuilder.findRandomLinkByCategory(
          LinkCategoryShard16.class, tenantId, category
      );
  }
  ...
  @Override
  default List<LinkCategoryShard16> findByTenantIdAndLinkId(
      Integer tenantId,
      Integer linkId
  ) {
      // Get the query builder from Spring context
      ...
      return queryBuilder.findByTenantIdAndLinkId(
          LinkCategoryShard16.class, tenantId, linkId
      );
  }
  ...
  default List<String> findAllDistinctCategories(
      ...
      return queryBuilder.findAllDistinctCategories(
          LinkCategoryShard16.class, tenantId
      );
  }

  @Override
  default List<LinkCategoryShard16> findByTenantId(
      Integer tenantId
  ) {
      // Get the query builder from Spring context
      LinkCategoryDynamicQueryBuilder queryBuilder = SpringContextUtil.getBean(LinkCategoryDynamicQueryBuilder.class);
  ...
  @Override
  default List<LinkCategoryShard16> findByTenantIdAndCategory(
      Integer tenantId,
      String category
  ) {
      // Get the query builder from Spring context
  ...
  @Override
  default List<LinkCategoryShard16> findByTenantIdAndCategoryOrderByRandomOrder(
      Integer tenantId,
      String category
  ) {
      // Get the query builder from Spring context
  ...
  @Override
  default List<LinkCategoryShard16> findByLinkId(
      Integer linkId
  ) {
      // Get the query builder from Spring context
      LinkCategoryDynamicQueryBuilder queryBuilder = SpringContextUtil.getBean(LinkCategoryDynamicQueryBuilder.class);
      return queryBuilder.findByLinkId(
          LinkCategoryShard16.class, linkId
      );
  }

  @Override
  default List<LinkCategoryShard16> findByCategoryAndTenantId(
      String category,
      Integer tenantId
  ) {
      // Get the query builder from Spring context
      ...
      return queryBuilder.findByCategoryAndTenantId(
          LinkCategoryShard16.class, category, tenantId
      );
  }
  ...
  @Override
  default List<LinkCategoryShard16> findRandomLinksByCategoryNames(
      Integer tenantId,
      ...
      return queryBuilder.findRandomLinksByCategoryNames(
          LinkCategoryShard16.class, tenantId, categoryNames
      );
  }
   ...
   */
  @Override
  default List<LinkCategoryShard16> findByCategoryWithFiltersPageable(
      Integer tenantId,
      String category,
      Integer minDuration,
      Integer maxDuration,
      ...
      return queryBuilder.findByCategoryWithDynamicFilters(
          LinkCategoryShard16.class, tenantId, category, minDuration, maxDuration, quality, offset, limit
      );
  }
  ...
  default Long countByCategoryWithFilters(
      ...
      return queryBuilder.countByCategoryWithDynamicFilters(
          LinkCategoryShard16.class, tenantId, category, minDuration, maxDuration, quality
      );
  }
   ...
   */
  @Override
  default List<LinkCategoryShard16> findByCategoryWithFiltersExcludingLinkPageable(
      Integer tenantId,
      String category,
      Integer minDuration,
      Integer maxDuration,
      ...
      return queryBuilder.findByCategoryWithDynamicFiltersExcludingLink(
          LinkCategoryShard16.class, tenantId, category, minDuration, maxDuration, quality, excludeId, offset, limit
      );
  }
}
