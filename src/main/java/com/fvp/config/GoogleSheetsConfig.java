...
public class GoogleSheetsConfig {
    ...
    /**
     * Creates a dummy Sheets service that logs operations instead of making actual API calls.
     * This ensures the application can start even if Google Sheets integration fails.
     */
