...
/**
 * Utility class to generate entity classes for LinkCategoryShard and LinkModelShard This is a
 * build-time utility and should not be included in the final application
 */
